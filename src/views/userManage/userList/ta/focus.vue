<template>
  <div class="app-container">
    ...
    <pagination
      ...
      :page.sync="pageNum"
      :limit.sync="pageSize"
      @pagination="queryFollowDetail"
    />
  </div>
</template>

<script>
import { getUserDetail, getFollowDetail } from "@/api/userManage/userList";
...
export default {
  ...
  methods: {
    ...
    async queryFollowDetail() {
      ...
      const { rows, total } = await getFollowDetail(postData);
